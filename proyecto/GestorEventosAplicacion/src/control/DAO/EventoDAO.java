...
public class EventoDAO {
    ...
    private static String cs_CONSULTA_EVENTOS_ACTIVOS = "SELECT K_CODIGO Codigo, N_NOMBRE Nombre FROM EVENTO  WHERE I_ESTADO = 'A' AND F_LIMITEINSCRIPCION > SYSDATE";
    private static String cs_CONSULTA_EVENTOS_ACTIVOS_CN = "SELECT K_CODIGO Codigo, N_NOMBRE Nombre FROM EVENTO WHERE I_ESTADO = 'A' AND K_CODIGO = ? AND N_NOMBRE = ? AND F_LIMITEINSCRIPCION > SYSDATE";
    private static String cs_CONSULTA_EVENTOS_ACTIVOS_C = "SELECT K_CODIGO Codigo, N_NOMBRE Nombre FROM EVENTO WHERE I_ESTADO = 'A' AND K_CODIGO = ? AND F_LIMITEINSCRIPCION > SYSDATE";
    private static String cs_CONSULTA_EVENTOS_ACTIVOS_N = "SELECT K_CODIGO Codigo, N_NOMBRE Nombre FROM EVENTO WHERE I_ESTADO = 'A' AND N_NOMBRE = ? AND F_LIMITEINSCRIPCION > SYSDATE";
